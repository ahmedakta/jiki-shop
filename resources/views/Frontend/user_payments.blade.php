                        ...
                        <div class="list-group" id="list-tab" role="tablist">
                            ...
                            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title" id="exampleModalLongTitle">{{__('Add a credit card')}}</h5>
                                    ...
                                    <form name="myForm">
                                        ...
                                        <button type="button" class="btn btn-primary" ng-click="postData('payments/store' , { formData : formData ,type: 'userPayment'})"  ng-disabled="myForm.$invalid" data-dismiss="modal">{{__('Add your card')}}</button>
                                    </form>
                                </div>
                                </div>
                                </div>
